...
"")
    ...
    # Import Button
        self.ImportVidbtn = QtWidgets.QPushButton(self.frame_3)
        self.ImportVidbtn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.ImportVidbtn.setStyleSheet("QPushButton:hover{\n"
"   icon: url(UI/Icons/downloadH.png);\n"
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("UI/Icons/download.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ImportVidbtn.setIcon(icon1)
        self.ImportVidbtn.setIconSize(QtCore.QSize(30, 30))
        self.ImportVidbtn.setObjectName("ImportVidbtn")
        self.gridLayout_2.addWidget(self.ImportVidbtn, 0, 0, 1, 1)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ImportVidbtn.setToolTip(_translate("MainWindow", "Import"))
